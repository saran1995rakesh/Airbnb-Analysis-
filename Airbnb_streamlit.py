...
def datafr():
    df= pd.read_csv(r"C:\Users\Administrator\Desktop\Projects\Airbnb_updated (1).csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open(r"C:\Users\Administrator\Desktop\Projects\airbnb.jpg")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv(r"C:\Users\Administrator\Desktop\Projects\Airbnb_updated (1).csv")
            return df_a
